...
public class FileSizeDiffPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        FileSizeDiffExtension extension = project.getExtensions()
            .create("diff", FileSizeDiffExtension.class);
        ...
        project.getTasks().register("fileSizeDiff", FileSizeDiffTask.class, task -> {
            ...
            task.getResultFile()
                .convention(project.getLayout().getBuildDirectory().file("diff-result.txt"));
        });
    }
}